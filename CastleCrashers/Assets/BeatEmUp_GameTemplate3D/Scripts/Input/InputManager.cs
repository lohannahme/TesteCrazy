...
public class InputManager : MonoBehaviour
{
    ...
    public delegate void DirectionInputEventHandlerP2(Vector2 dir, bool doubleTapActive);
    public static event DirectionInputEventHandlerP2 onDirectionInputEventP2;
    ...
    public static void DirectionEventP2(Vector2 dir, bool doubleTapActive)
    {
        if (onDirectionInputEventP2 != null) onDirectionInputEventP2(dir, doubleTapActive);
    }
    ...
    void KeyboardControls()
    {
        ...
        foreach (InputControl inputControl in keyBoardControls)
        {
            ...
            if (Input.GetKey(inputControl.key))
            {
                ...
                if (_coop)
                {
                    if (inputControl.Action == "LeftP2") x2 = -1f;
                    else if (inputControl.Action == "RightP2") x2 = 1f;
                    else if (inputControl.Action == "UpP2") y2 = 1;
                    else if (inputControl.Action == "DownP2") y2 = -1;
                }
            }
            ...
            if (_coop)
            {
                if (inputControl.Action == "DefendP2") defendKeyDown = Input.GetKey(inputControl.key);
            }
        }
        ...
        if (_coop)
        {
            DirectionEventP2(new Vector2(x2, y2), doubleTapState);
        }
    }
