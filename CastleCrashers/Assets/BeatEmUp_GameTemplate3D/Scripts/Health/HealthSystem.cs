...
public class HealthSystem : MonoBehaviour {
	...
	public delegate void OnHealthChange(float percentage, GameObject GO, bool isPlayerTwo);
	...
	void SendHealthUpdateEvent(){
		...
		if(onHealthChange != null) onHealthChange(CurrentHealthPercentage, gameObject, _isPlayerTwo);
	}
