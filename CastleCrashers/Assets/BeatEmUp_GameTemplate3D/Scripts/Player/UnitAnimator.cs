...
public class UnitAnimator : MonoBehaviour {
	...
	public void ShowDefendEffect() {
		GameObject.Instantiate(DefendEffect, transform.position + Vector3.up * .6f, Quaternion.identity);
	}
	...
	public void SpawnProjectile(){
		...
		if(playerCombat){
			...
			GameObject projectilePrefab = GameObject.Instantiate(_playerCombat.weapon.projectile, spawnPos, Quaternion.identity) as GameObject;
